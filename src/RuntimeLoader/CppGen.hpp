...
public:
	...
	std::string defaultOptions = "-fPIC -static -static-libgcc -static-libstdc++ -std=c++20 -Iinclude -Wl,-rpath='${ORIGIN}/..'";
#else
	std::string sharedObjectExtention = ".so";
	std::string defaultOptions = "-fPIC -std=c++20 -Iinclude -Wl,-rpath='${ORIGIN}/..'";
#endif
