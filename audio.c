 ...
 */
#define SDL_AUDIO_ALLOW_CHANGES 0//for some reason for compatability, all these compatability options should be off.
...
static inline void playAudio(const char * filename, Audio * audio, uint8_t loop, int volume)
{
    ...
    audio->startTime = audioTime;
    newAudio->startTime = audioTime;
