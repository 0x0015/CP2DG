/*
    This file was generated using https://github.com/mosra/flextgl:
        ...
        path/to/flextGLgen.py -D Generated -T compatible profiles/exampleProfile.txt
...
static void add_extension(const char* extension)
{
    ...
    if (strcmp("GL_ARB_compute_shader", extension) == 0) {
        FLEXT_ARB_compute_shader = GL_TRUE;
    }
    if (strcmp("GL_ARB_shader_storage_buffer_object", extension) == 0) {
